      ...
      <main className="min-h-screen bg-navy flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-cream rounded-3xl shadow-2xl p-8 md:p-10">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-extrabold text-navy">Selamat datang kembali!</h1>
            <p className="text-navy/60 text-sm mt-1">Masuk ke akun Mathematalk Anda</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="text-right">
              <Link href="/lupa-password" className="text-sm text-navy/60 hover:text-gold transition-colors">Lupa Password?</Link>
            </div>
            <button
              type="submit"
              disabled={loading}
